...
import ShimaNahar from "../../assets/veriff/shima-nahar.jpg";

export default function MyVeriffOne() {
  return (
    <div className="py-20 container">
      ...
      <div className="border border-green-500 p-5" id="veriff-btn">
        <img className="mb-5" src={ShimaNahar} alt="veriff scan image" />
        <hr />
        <button className="py-2 px-8 bg-green-500 rounded-md text-white font-bold mt-5">
          <a href="https://veriff.me/s/qyEQEgrah">Verify Me</a>
        </button>
      </div>
