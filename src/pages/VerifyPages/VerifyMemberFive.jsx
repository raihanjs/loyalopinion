...
import Habibullah from "../../assets/veriff/habibullah.jpg";

export default function VerifyMemberFive() {
  return (
    <div className="py-20 container">
      <h1 className="font-bold">Time Reamining: 48 Hours</h1>
      ...
      <div className="border border-green-500 p-5" id="veriff-btn">
        <img className="mb-5" src={Habibullah} alt="veriff scan image" />
        <hr />
        <button className="py-2 px-8 bg-green-500 rounded-md text-white font-bold mt-5">
          <a href="https://veriff.me/s/lJKqe7OAj">Verify Me</a>
        </button>
      </div>
