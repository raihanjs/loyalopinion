...
import Hanif from "../../assets/veriff/HanifAhamed.jpg";

// sent to Sk Hanif Ahamed on 28th sept 2024
// Mpiash33

export default function HanifAhamed(){
    return (
      ...
      <div className="border border-green-500 p-5" id="veriff-btn">
        <img className="mb-5" src={Hanif} alt="veriff scan image" />
        <hr />
        <button className="py-2 px-8 bg-green-500 rounded-md text-white font-bold mt-5">
          <a href="https://veriff.me/s/g5Wwv9AFR">Verify Me</a>
        </button>
      </div>
