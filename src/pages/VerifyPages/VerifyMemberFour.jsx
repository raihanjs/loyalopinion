...
import four from "../../assets/veriff/four.jpg";

// Sent to Tamanna

export default function VerifyMemberFour() {
  return (
    <div className="py-20 container">
      ...
      <div className="border border-green-500 p-5" id="veriff-btn">
        <img className="mb-5" src={four} alt="veriff scan image" />
        <hr />
        <button className="py-2 px-8 bg-green-500 rounded-md text-white font-bold mt-5">
          <a href="https://veriff.me/s/Vrda9ISCM">Verify Me</a>
        </button>
      </div>
