...
import Redoyan from "../../assets/veriff/Redoyan.jpg";

// sent to Sk Redoyan Ahmed <rafsanahmed02@gmail.com> on 28th sept 2024
// ronniejunior1983@gmail.com

export default function SkRedwan(){
    return (
      ...
      <div className="border border-green-500 p-5" id="veriff-btn">
        <img className="mb-5" src={Redoyan} alt="veriff scan image" />
        <hr />
        <button className="py-2 px-8 bg-green-500 rounded-md text-white font-bold mt-5">
          <a href="https://veriff.me/s/COKT2Npw9">Verify Me</a>
        </button>
      </div>
