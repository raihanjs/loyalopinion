...
import devon9090 from "../../assets/veriff/devon9090.jpg";

// sent to habibullah faisal on 28th sept 2024

export default function Devon9090(){
    return (
      ...
      <div className="border border-green-500 p-5" id="veriff-btn">
        <img className="mb-5" src={devon9090} alt="veriff scan image" />
        <hr />
        <button className="py-2 px-8 bg-green-500 rounded-md text-white font-bold mt-5">
          <a href="https://veriff.me/s/aYUKUv79k">Verify Me</a>
        </button>
      </div>
