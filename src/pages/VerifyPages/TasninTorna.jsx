...
import TasninImg from "../../assets/veriff/tasnintorna474Valued.png";

// Sent to TasninTorin 4th october 2024 // Tasmim Roshni <tasmimroshni23@gmail.com>

export default function TasninTorna(){
    return (
        ...
        <div className="border border-green-500 p-5" id="veriff-btn">
          <img className="mb-5" src={TasninImg} alt="veriff scan image" />
          <hr />
          <button className="py-2 px-8 bg-green-500 rounded-md text-white font-bold mt-5">
            <a href="https://veriff.me/s/xbsM69SWG">Verify Me</a>
          </button>
        </div>
