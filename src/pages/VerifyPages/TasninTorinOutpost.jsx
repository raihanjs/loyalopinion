...
import TasninImg from "../../assets/veriff/tasnin-torin.png";

// Sent to TasninTorin 3rd october 2024 // Tasnin Torna <tasnintornany@gmail.com>

export default function TasninTorinOutpost(){
    return (
        ...
        <div className="border border-green-500 p-5" id="veriff-btn">
          ...
          <button className="py-2 px-8 bg-green-500 rounded-md text-white font-bold mt-5">
            <a href="https://veriff.me/s/V9Q3rRXHD">Verify Me</a>
          </button>
        </div>
